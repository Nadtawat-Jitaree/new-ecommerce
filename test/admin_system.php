...
<body>
    ...
    <div style="margin-top: 80px;margin-left: 20%;margin-right: 20%;">
        <h3>เมนูผู้ดูแลระบบ</h3> <a href="add_type_restaurant.php" class="btn btn-success my-1">เพิ่มประเภทร้านอาหาร</a> <a href="verify_admin_restaurant.php" class="btn btn-success my-1">อนุมัติผู้ดูแลร้านอาหาร</a>
